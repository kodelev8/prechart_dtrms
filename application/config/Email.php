...
class CI_Email {
	...
	var	$smtp_host		= "ssl://smtp.mailgun.org";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "postmaster@sandbox4755e6fee8f947c7b0940c7894bbd9d9.mailgun.org";		// SMTP Username
	var	$smtp_pass		= "63kbo4kuy-d8";		// SMTP Password
	...
	var	$_protocols		= array('mail', 'sendmail', 'smtp','html');
